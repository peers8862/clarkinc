...
- Facts stay in `docs/research.md` until they are strong enough to promote.
- Only evidence-backed conclusions should move into `docs/business-plan.md`, `docs/venture-overview.md`, or `docs/pitch.md`.
...
| --- | --- | --- | --- | --- | --- |
| 1 | Beachhead customer selection | Research agent | Ready for Decision | Ranked list of target segments with buyer, urgency, program type, and fit | `docs/venture-overview.md`, `docs/business-plan.md` |
| 2 | Competitor and analog map | Research agent | Active | Comparison table for MacroFab, STI, EMS firms, firmware consultancies, and IPC training providers | `docs/research.md`, `docs/pitch.md` |
| 3 | Corridor advantage validation | Research agent | Ready for Decision | Hamilton-Buffalo corridor memo with logistics, talent, and relative advantage analysis | `docs/research.md`, `docs/pitch.md` |
| 4 | Incentive and policy validation | Research agent | Ready for Decision | Claim-by-claim validation sheet for Canadian and New York incentives and policy tailwinds | `docs/research.md`, `docs/business-plan.md` |
| 5 | Fee stack and node economics | Business-plan agent | Ready for Decision | Draft platform economics model covering training-first revenue, ownership, bundled software, and capital recycling | `docs/business-plan.md`, `docs/venture-overview.md` |
| 6 | Software scope definition | Business-plan agent | Promoted | Version 1 boundary for software, tooling, messaging, and agent infrastructure | `docs/business-plan.md`, `docs/network-operating-model.md`, `docs/clarkware.md` |
| 7 | Dunkirk scope decision | Orchestrator + business-plan agent | Active | Classification of Dunkirk as core asset, later option, or out of scope | `docs/venture-overview.md`, `docs/business-plan.md`, `docs/pitch.md` |
| 8 | Workforce housing scope decision | Orchestrator + business-plan agent | Queued | Classification of housing concept as core, adjacent, or out of scope | `docs/venture-overview.md`, `docs/business-plan.md` |
| 9 | Hamilton training legal/commercial model | Orchestrator + business-plan agent | Promoted | Defined operating structure for CLARK's direct Hamilton training operation inside Niagara Assembly | `docs/hamilton-training-model.md`, `docs/business-plan.md`, `docs/venture-overview.md` |
...
- Current first-pass result: industrial controls, smart-energy hardware, sensor modules, edge devices, and rugged instrumentation appear to be the strongest current cluster.
- Required output:
...
- Current founder input: assume a strong early push to bring a partnership together in Dunkirk.
- Required output:
...
- Current status:
  ...
  - Remaining work is to test the proposed fee bands against expected course demand, convert them into draft agreement language, and choose the implementation path for verifiable Clark Certified records by the end of year 1.
- Promotion rule:
