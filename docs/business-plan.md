...
- Target market: Industrial, defense-adjacent, and advanced hardware customers in the United States and Canada.
...
- Primary segment: Advanced hardware companies and industrial programs needing low-volume, high-complexity electronics assembly.
...
- SAM: US and Canadian industrial and defense-adjacent customers requiring trusted regional precision assembly and firmware-aware support.
- SOM: Binational corridor demand reachable from Hamilton, Buffalo, and related logistics infrastructure in the first 24 months.
- Bottom-up estimate: To be developed from target accounts, average program value, node throughput, utilization assumptions, and the volume of corridor-accessible demand.

## Product And Platform Strategy

- Version 1 scope: Prove the Hamilton-Buffalo corridor with repeatable operating standards, training-first revenue, shared tooling, customer delivery, and facility-aware software that improves visibility and accountability.
...
Hamilton is the founding node and primary R&D engine. Its likely role is to lead firmware optimization, process development, and portions of the platform software and IP portfolio.
...
### Dunkirk Logistics And Partnership Push

Dunkirk is a candidate storage and shipping hub intended to support warehousing and distribution economics on the US side of the corridor. The current working plan assumes a strong early push to assemble a partnership there, even though the exact role still needs separate validation.

## Go-To-Market

- Phase 1: Launch IPC certification revenue and train-the-trainer activity enabled through EPTAC in Markham, Ontario, while pairing it with CLARK's own wraparound Clark Courses modules.
...
- Clark Courses revenue from modular CLARK-branded wraparound instruction that complements IPC pathways
- Early CLARK-sponsored training operations as the first cash-generating layer of the model

### Phase 2: Node Operating Revenue

As Niagara Assembly comes online for testing and assembly contracts, direct node operating revenue begins to matter. This provides the first proof that the corridor can convert training-led presence into production-led commercial activity.
...
- Logistics coordination and infrastructure fees for freight, customs support, routing, warehousing, and consolidated shipment workflows
- Training license fees for access to IPC-certified programs and curriculum materials
...
- Node onboarding fees for facility evaluation, selection, and integration
...
- Year 1 revenue mix: Weighted toward training revenue and early operating services rather than mature platform fees.
- Year 2 revenue mix: Increasing contribution from assembly services, platform licensing, software, training, logistics fees, and greater node throughput.
...
| Scope risk | Software tools, logistics infrastructure, training, Dunkirk partnership efforts, and possible housing initiatives may expand scope faster than the core model can support. | Prioritize the minimum platform needed to prove the first corridor. |
...
- Advance a strong early partnership push in Dunkirk.
...
- Decide whether Dunkirk should become part of the active operating footprint.
